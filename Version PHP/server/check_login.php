<?php
	...
	//REVOKE ALL PRIVILEGES ON nextu_diego FROM 'login_user'@'localhost';
	//GRANT SELECT (emai, clave) ON nextu_diego.usuarios TO 'login_user'@'localhost';

  $con = new ConectorBD('localhost','root','');
	$respuesta['msg'] = $con->iniciarConexion('nextu_diego');
